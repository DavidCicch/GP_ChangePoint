...
from inference_new import inference_loop, smc_inference_loop, smc_inference_loop_trace
from inference_new import update_metropolis
# from inference import inference_loop, smc_inference_loop, smc_inference_loop_trace
# from inference import update_metropolis
import copy 
from abc import ABC, abstractmethod
import Poisson_Process_added
            ...
            if mode == 'gibbs-in-smc':
                ...
                def mcmc_step_fn(key, state, temperature, **mcmc_parameters):
                    ...
                    def poisson_process_step(key, position, temperature):
                        ...
                        # num_names = [x for x, obj in zip(names, priors_flat) if isinstance(obj, Poisson_Process_added.Poisson_Process_hyper)]
